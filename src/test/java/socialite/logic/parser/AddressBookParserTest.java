...
public class AddressBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        Command parseCommand = parser.parseCommand(PersonUtil.getAddCommand(person), null);
    ...
    public void parseCommand_delete() throws Exception {
        DeleteCommand command = (DeleteCommand) parser.parseCommand(
                DeleteCommand.COMMAND_WORD + " " + TypicalIndexes.INDEX_FIRST_PERSON.getOneBased(), null);
    ...
    public void parseCommand_edit() throws Exception {
        ...
        EditCommand command = (EditCommand) parser.parseCommand(EditCommand.COMMAND_WORD + " "
                ...
                + " " + PersonUtil.getEditPersonDescriptorDetails(descriptor), null);
    ...
    public void parseCommand_unknownCommand_throwsParseException() {
        Assert.assertThrows(ParseException.class, Messages.MESSAGE_UNKNOWN_COMMAND, ()
            -> parser.parseCommand("unknownCommand", null));
    }
    ...
    public void parseCommand_remark() throws Exception {
        ...
        RemarkCommand command = (RemarkCommand) parser.parseCommand(RemarkCommand.COMMAND_WORD + " "
                + INDEX_FIRST_PERSON.getOneBased() + " " + PREFIX_REMARK + remark.get(), null);
