...
public class UnpinCommandParserTest {
    ...
    public void parse_validArgs_returnsPinCommand() {
        CommandParserTestUtil.assertParseSuccess(parser, "1", new UnpinCommand(TypicalIndexes.INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        CommandParserTestUtil.assertParseFailure(
                parser, "a", String.format(Messages.MESSAGE_INVALID_COMMAND_FORMAT, UnpinCommand.MESSAGE_HELP_GUIDE)
        );
    }
}