...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                ...
                VALID_FACEBOOK, VALID_INSTAGRAM, VALID_TELEGRAM, VALID_TIKTOK, VALID_TWITTER
        );
    ...
    public void toModelType_invalidFacebook_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                ...
                INVALID_FACEBOOK, VALID_INSTAGRAM, VALID_TELEGRAM, VALID_TIKTOK, VALID_TWITTER
        );
    ...
    public void toModelType_invalidInstagram_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(
                VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS, VALID_REMARK, VALID_TAGS,
                VALID_FACEBOOK, INVALID_INSTAGRAM, VALID_TELEGRAM, VALID_TIKTOK, VALID_TWITTER
        );
